...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    /**
     * Get the core path of the Laravel installation.
     *
     * @return string
     */
    public function corePath()
    {
        return $this->systemPath().DIRECTORY_SEPARATOR.'core';
    }
    ...
    {
        return $this->corePath().DIRECTORY_SEPARATOR.'bootstrap';
    }
    ...
    {
        return $this->systemPath().DIRECTORY_SEPARATOR.'config';
    }
